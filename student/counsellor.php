...
<div class="container-fluid">
    ...
    <div class="card shadow mb-2">
        ...
        if ($_POST) {
            ...
            $sqlmain = "select * from counsellor order by counid desc";
        }
                    ...
                    <tbody>
                        ...
                        if ($result->num_rows == 0) {
                            echo '<tr>
                                ...
                                <a class="non-style-link" href="counsellor.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Show all Counsellors &nbsp;</font></button>
                                </a>
                                </center>
                                <br><br><br><br>
                                </td>
                            ...
                            for ($x = 0; $x < $result->num_rows; $x++) {
                                ...
                                &nbsp;&nbsp;&nbsp;
                                <a href="?action=session&id=' . $counid . '&name=' . $name . '"  class="non-style-link"><button  class="btn-primary-soft btn button-icon menu-icon-session-active"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Sessions</font></button></a>
                                    </div>
                                    </td>
                                </tr>';
                            }
