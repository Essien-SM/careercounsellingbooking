...
$userrow = $database->query("select * from counsellor where counemail='$useremail'");
$userfetch=$userrow->fetch_assoc();
$userid= $userfetch["counid"];
$username=$userfetch["counname"];
...
?>
    <!-- Main Content -->
    <div style="background-image: url(../img/back.png);" id="content">
